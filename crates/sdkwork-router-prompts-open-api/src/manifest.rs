pub const ROUTE_MANIFEST_PATH: &str = "sdks/_route-manifests/open-api/sdkwork-router-prompts-open-api.route-manifest.json";
pub const SCHEMA_VERSION: u32 = 1;
pub const MANIFEST_KIND: &str = "sdkwork.route.manifest";
pub const PACKAGE_NAME: &str = "sdkwork-router-prompts-open-api";
...
pub const API_AUTHORITY: &str = "sdkwork-intelligence-prompts-open-api";
pub const SDK_FAMILY: &str = "sdkwork-intelligence-prompts-sdk";
